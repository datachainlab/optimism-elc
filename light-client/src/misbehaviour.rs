    ...
    pub fn verify(
        ...
        self.resolved.fault_dispute_game_factory_proof
            .verify_resolved_status(
                ...
                self.resolved.resolved_output_root,
            )?;
        ...
        if consensus_l2_number >= self.resolved.resolved_l2_number {
...
impl<const SYNC_COMMITTEE_SIZE: usize> L2PastMisbehaviour<SYNC_COMMITTEE_SIZE> {
    ...
    pub fn verify(
        ...
        if contradict_resolved_output_root == self.resolved.resolved_output_root {
...
mod test {
    ...
    fn default_fault_dispute_game_factory_proof() -> FaultDisputeGameFactoryProof {
        // op-sepolia
